<template>
	<div class="diy_list page_disaster_rescue" id="disaster_rescue_list">
		<div class="warp">
			<div class="container diy_list_container">
				<div class="diy_list_title">
					<div class="col">
						<span class="title">灾情救援列表</span>
					</div>
				</div>
				...
				<div class="row diy_list_box">
					<div class="col">
						<!-- 列表 -->
						<list_disaster_rescue :list="list" />
						<!-- /列表 -->
					</div>
				</div>
...
<script>
	import list_disaster_rescue from "@/components/diy/list_disaster_rescue.vue";
