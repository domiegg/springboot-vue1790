<template>
	<div class="diy_details_box diy_div_disaster_classification">
		<div class="warp">
			<div class="container">
	...
	export default {
		...
		methods: {
			...
			change_praise(obj) {
				...
				var query = {
					source_table: "disaster_classification",
					source_field: "disaster_classification_id",
					source_id: this.obj["disaster_classification_id"],
					user_id
				};
				...
				if (this.state_praise) {
					...
					this.$get('~/api/praise/del?', query, (res) => {
						if(res.result){
							...
							this.$post('~/api/disaster_classification/set?disaster_classification_id=' + _this.obj["disaster_classification_id"], {
								praise_len
							}, (res) => {
								if(res.result){
